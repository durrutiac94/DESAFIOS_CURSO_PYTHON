...
# Formula de referencia (si se corrige): monto_final = capital x (1 + tasa / 100) ^ anios;
#  ganancia_real = monto_final / (1 + inflacion / 100) ^ anios - capital
...
ganancia_real = (monto_final / factor_inflacion) - capital 
